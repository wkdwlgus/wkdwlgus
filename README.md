...
- GitHub: [키즈 챗봇 서비스 깃허브](https://github.com/wkdwlgus/kids-chatbot-service-refactor)
...
- GitHub: [CRM 메시지 생성기 깃허브](https://github.com/wkdwlgus/crm-message-generator)
...
- GitHub
  - [대규모 트래픽 티켓팅 플랫폼 AI 방어 서버 깃허브](https://github.com/goorm-gongbang/201-goormgb-ai)
